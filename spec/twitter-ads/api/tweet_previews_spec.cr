...
describe TwitterAds::Api::TweetPreviews do
  ...
  describe "#tweet_previews" do
    it "returns Array(TwitterAds::TweetPreview)" do
      tweet_previews = client.tweet_previews("18ce54d4x5t", "PUBLISHED", [1122911801354510336,1102836745790316550])
      tweet_previews.size.should eq 2

      tweet_preview = tweet_previews.first
